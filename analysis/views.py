...
def chart(request):
    # Histogram
    csv_wait_times = settings.MEDIA_ROOT + 'store/analysis/dataset.xlsx'
    data_second = pd.read_excel(csv_wait_times, sheet_name='Wait_times')
    hist = get_hist(data_second, 'seconds', 'Customer Wait Times')
